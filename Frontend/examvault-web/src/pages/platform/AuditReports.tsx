...
// Matches reports.png's Audit Reports screen. Real - a re-skin of
// Security > Audit Logs' existing real data (same getAuditLogs call),
// with a Role column added by cross-referencing the AllUsers list by
// userId (no new backend data, just a join done client-side).
