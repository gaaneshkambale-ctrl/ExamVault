// Shared between ManageExamTypes.tsx (the exam-type list) and CreateExam.tsx
// (the card-based Exam Type picker) so both render the same icon for the
// same type - moved here instead of living in just one of the two pages.
...
// Cosmetic keyword match against a tenant's own exam-type name - deterministic,
// not stored anywhere. Falls back to a generic tag for any custom name that
// doesn't match one of the common defaults.
export function iconForExamType(name: string) {
