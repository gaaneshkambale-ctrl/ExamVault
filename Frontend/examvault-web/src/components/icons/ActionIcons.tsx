// Small line-icon set for row/inline action buttons across admin tables
// (View/Edit/Delete and a few page-specific actions). Centralized so every
// list page's Actions column looks and behaves the same way instead of each
// page hand-rolling its own icon markup.

interface IconProps {
  size?: number;
}

export function ViewIcon({ size = 15 }: IconProps) {
  return (
...
export function ReorderIcon({ size = 15 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
