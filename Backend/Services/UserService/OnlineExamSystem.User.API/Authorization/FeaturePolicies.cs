...
// JwtTokenService embeds at login/refresh from the tenant's current Plan.
// Duplicated per gated service rather than shared, matching this codebase's
// existing precedent (health checks, exception middleware).
