...
namespace OnlineExamSystem.User.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925173443_AddSessionStartedAtUtcToRefreshToken")]
    partial class AddSessionStartedAtUtcToRefreshToken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineExamSystem.User.Domain.Entities.AcademicListItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("TenantId", "ListType", "ParentId");

                    b.ToTable("AcademicListItems");
                });
            ...
            modelBuilder.Entity("OnlineExamSystem.User.Domain.Entities.EmailConfirmationToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnlineExamSystem.User.Domain.Entities.AcademicListItem", b =>
                {
                    b.HasOne("OnlineExamSystem.User.Domain.Entities.AcademicListItem", null)
                        .WithMany()
