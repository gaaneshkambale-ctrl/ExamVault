...
/// insert" sequence (e.g. CreateExamHandler's local MaxExams count check)
/// against a genuine race where two concurrent requests both pass the count
/// check before either commits, together exceeding the limit. Implemented in
...
/// rather than reading a stale count. Duplicated from User Service's own
