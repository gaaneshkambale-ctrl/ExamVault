...
public class RefreshTokenHandlerTests
{
    ...
    private static RefreshTokenHandler CreateHandler(FakeUserRepository repository) => new(repository, new FakePlanRepository(), new FakeRolePermissionRepository(), Jwt);
